...
def deal_data(count1, count2):
    ...
    # sava_path = 'data/distance_' + distance + '/' + tag_pair + '/' + tag_pair + count1 + count2
    sava_path = f'data/dataset/{tag_pair}/distance_{distance}/{tag_pair}{count1}{count2}'
    ...
    plt.title('Phase Diff ' + distance + ' ' + tag_pair + " " + count1 + count2)
    plt.xlabel("Freq")
    plt.ylabel("Degree")
