...
for index, value in x_train_path.iteritems():
    x_train_data = np.array(pd.read_csv('../tagPair/data/' + value))
...
for index, value in x_test_path.iteritems():
    x_test_data = np.array(pd.read_csv('../tagPair/data/' + value))
...
print(classification_report(y_test, dtc_y_predict, target_names=['TagPair A', 'TagPair B']))
...
print(classification_report(y_test, rfc_y_predict, target_names=['TagPair A', 'TagPair B']))