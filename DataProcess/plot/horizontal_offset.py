...
# foo_fig.savefig(f'D:/Graduate/Paper Writing/大论文/Figure/3_水平偏移距离的影响.pdf', format='pdf', dpi=1000,
#                 bbox_inches='tight')
foo_fig.savefig(f'D:/Graduate/Paper Writing/大论文/Figure/3_水平偏移距离的影响.png', format='png', dpi=400,
                bbox_inches='tight')
plt.show()
