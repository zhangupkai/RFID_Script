...
def locate_degree_F001_F005(phase, freq):
    ...
    print(peaks)
    degree_90 = phase[peaks[0]]
    degree_45 = phase[peaks[0] - peak_interval_unit]
    degree_0 = phase[peaks[0] - peak_interval_unit * 2]
    degree_135 = phase[peaks[0] + peak_interval_unit]
    degree_180 = phase[peaks[0] + peak_interval_unit * 2]
    degree_225 = phase[peaks[0] + peak_interval_unit * 3]
    degree_270 = phase[peaks[0] + peak_interval_unit * 4]
    degree_315 = phase[peaks[0] + peak_interval_unit * 5]
    degree_360 = phase[peaks[0] + peak_interval_unit * 6]
