...
def locate_degree(timestamp, phase, tag_pair, freq):
    ...
    elif tag_pair == 'E004_E005':
        return locate_degree_E004_E005(phase, freq)
    elif tag_pair == 'C001_C002':
        return locate_degree_C001_C002(phase, freq)
    elif tag_pair == 'C003_C004':
        return locate_degree_C003_C004(phase, freq)
    elif tag_pair == 'F002_F003':
        return locate_degree_F002_F003(phase, freq)
    """

    return locate_degree_common(phase, freq)
